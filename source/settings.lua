...
function settings:init(...)
	...
	gfx.sprite.setBackgroundDrawingCallback(function(x, y, width, height) -- Background drawing
		...
		if vars.selections[vars.selection] == "music" then
			...
			assets.small:drawTextAligned(text('crank') .. text('separator') .. text(tostring(save.crank)), 200, 80, kTextAlignment.center)
			assets.small:drawTextAligned(text('shaking') .. text('separator') .. text(tostring(save.shaking)), 200, 100, kTextAlignment.center)
			assets.small:drawTextAligned(text('mic') .. text('separator') .. text(tostring(save.mic)), 200, 120, kTextAlignment.center)
			assets.small:drawTextAligned(text('viewcredits'), 200, 140, kTextAlignment.center)
			assets.small:drawTextAligned(text('manual1'), 200, 170, kTextAlignment.center)
			assets.small:drawTextAligned(text('manual2'), 200, 190, kTextAlignment.center)
